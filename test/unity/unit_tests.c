...
/* macaroons */
#include <libmacaroons/macaroons-inner.h>
...
void test_serialization_3(void) {
    TEST_ASSERT_NOT_NULL_MESSAGE(deserialize_macaroon(
...
int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_serialization_1);
    RUN_TEST(test_serialization_2);
    RUN_TEST(test_serialization_3);
    return UNITY_END();
}